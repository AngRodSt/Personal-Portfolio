  ...
  return (
    <>
      <div className={`relative  `}>
          ...
          <div className=" container mx-auto py-5 flex lg:justify-between flex-col lg:flex-row justify-center items-center">
            <div className="mb-5 cursor-pointer">
              <Link
                ...
                smooth={true}
                duration={500}
                className=" text-gray-200 covered-by-your-grace-regular text-4xl neon-text-black"
              >
                AngRod<span className="text-cyan-500 neon-text-cyan">Sx</span>
              </Link>
            </div>
            ...
            <nav className="  flex gap-5 montserrat text-gray-200  cursor-pointer">
              <Link
                ...
                smooth={true}
                duration={500}
                className="hover:scale-125 transition hover:neon-text-cyan "
              >
                Home
              </Link>
              <Link
        ...
        <div
          className={`absolute inset-0 h-full bg-[url(/pc.jpg)] bg-cover bg-no-repeat bg-fixed filter grayscale opacity-0  ${
