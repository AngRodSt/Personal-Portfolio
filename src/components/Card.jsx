...
const Card = ({
  ...
  return (
    <>
      <div
        data-aos="flip-right"
        className="   bg-gray-100 rounded-lg  overflow-hidden hover:scale-110 transition ease-in-out"
        style={{
          boxShadow:
          ...
          >
            <div className=" mt-5 py-20  align-middle items-center">
              ...
              >
                ...
                <div
                  className="absolute bottom-3 gap-3 flex flex-row  z-10"
                  style={{}}
                >
                  <a
                    href={githubLink}
                    ...
                    className="hover:scale-125 transition ease-in-out z-0"
                  >
                    <Github />
                  </a>
                  <a
