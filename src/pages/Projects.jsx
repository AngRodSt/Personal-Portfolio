      ...
      <div className=" relative min-h-screen pt-24 lg:pt-20 bg-gradient-to-b from-transparent   to-cyan-500/90  backdrop-blur-sm cursor-default">
        ...
        <div className="container mx-auto  p-10 lg:p-18 grid grid-cols-1 xl:grid-cols-3  md:grid-cols-2 gap-10">
          <Card
            ...
            type={"Full Stack App"}
            description={
              "Dynamic web application tailored for a small entrepreneurship focused on 3D design and 3D printing services. The platform integrates an e-commerce section powered by the Shopify API, allowing customers to easily browse and purchase products. (Products showcased on the page are for illustrative purposes.) Beyond the shop, the application offers a custom service request system for personalized 3D design and printing projects. The site combines a clean, modern interface with scalable backend features to support growth and client engagement."
            }
          ...
          <Card
            ...
            type={"Full Stack App"}
            description={
              "Web application for managing veterinary clinic patients. It enables veterinarians to register, update, and manage appointments efficiently. It features secure authentication, password recovery, and data storage in MongoDB Atlas. Its intuitive design enhances the user experience, streamlining patient and appointment management."
            }
          ...
          <Card
            ...
            title={"Travel Agency"}
            type={"Full Stack App"}
            tecnologys={"Node.js | Express | Tailwind | Pug | Sequelize |"}
            description={
              "This travel agency simulation, allows managing and dynamically displaying travel information stored in a database. Users can explore destinations and add testimonials through a form, with the data being saved to the database and displayed on the website. The application uses Pug for dynamic rendering and Sequelize as an ORM to handle data persistence, providing a smooth and interactive experience."
            }
          />
          ...
          <Card
            ...
            type={"UI Mockup"}
            description={
              "A clean and responsive mockup for an online course store. It includes a landing page, course listing and a functional shopping cart that stores items in localStorage, it's ready for dynamic data integration and full functionality."
            }
          ...
          <Card
            ...
            title={"Crypto Finder"}
            description={
              "Practical application that allows users to query real-time cryptocurrency values through an API. Users can select different currencies and view their updated exchange rates in a simple and intuitive interface."
            }
          ...
          <Card
            ...
            type={"FrontEnd App"}
            description={
              "Web that allows users to search and explore high-quality images using the Pixabay API. With a simple interface, users can enter keywords to find related images and view them instantly."
            }
            tecnologys={"HTML | JavaScript | Tailwindcss |"}
          />
          ...
          <Card
            ...
            type={"FrontEnd App"}
            description={
              "Web that allows users to check the current weather, displaying the maximum and minimum temperatures for a specific location, all retrieved via a weather API. The interface is simple and easy to use, providing quick and accurate temperature details."
            }
            tecnologys={"HTML | JavaScript | Tailwindcss | "}
          />
          ...
          <Card
            ...
            type={"FrontEnd App"}
            description={
              "Web application that enables users to browse recipes by categories using an API. It showcases a range of dishes, providing detailed information on how to prepare them, including ingredients and instructions, all within a simple and intuitive interface."
            }
